...
<!-- AUDIT_MERGE_ENFORCEMENT_ENTRYPOINT_V1 -->
Merge enforcement obrigatório: leia `docs/quality/AUDIT_MERGE_ENFORCEMENT_V1.md`; o gate local deve executar `scripts/absolute-audit-governance-validate.sh`, e todo push publicado em main/master deve passar pelo workflow **Absolute Audit Main Guard**.
