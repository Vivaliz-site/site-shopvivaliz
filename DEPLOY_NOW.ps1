...
$remoteDir = "/home/shopvivaliz/shopvivaliz"
...
ssh -i $sshKey -o StrictHostKeyChecking=no $server "sudo mkdir -p $remoteDir && sudo chown -R ubuntu:ubuntu /home/shopvivaliz"
