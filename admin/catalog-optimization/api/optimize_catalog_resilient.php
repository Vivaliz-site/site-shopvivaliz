...
foreach ($providers as $resolvedProvider) {
    ...
    try {
        ...
        // O rascunho pode ser preservado para revisao humana mesmo com falhas
        // editoriais. A publicacao continua protegida: admin_catalog.php executa
        // novamente o quality gate estrito antes de qualquer chamada externa.
