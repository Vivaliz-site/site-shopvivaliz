    ...
    <nav class="navbar" style="background: #1a1a2e; padding: 1rem 0;">
        <div class="container nav-inner" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div class="navbar-menu" style="display: flex; gap: 0.5rem; flex-wrap: wrap; font-size: 0.9rem;">
                ...
                <a href="/admin/ai-squad.php" style="color: white; text-decoration: none; padding: 0.5rem 1rem; border-radius: 4px; background: rgba(37,99,235,0.35);">🤖 Squad Chat</a>
    ...
    <main class="catalog-page">
        ...
        <section class="container admin-overview" style="margin-top: 2rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
                ...
                <a href="/admin/settings-frete.php" style="background: #d946ef; color: white; padding: 1.5rem; border-radius: 8px; text-decoration: none; text-align: center; font-weight: bold; transition: all 0.3s;">
                    🚚 Frete Grátis
                </a>
                ...
                <a href="/admin/ai-squad.php" style="background: #1f3a70; color: white; padding: 1.5rem; border-radius: 8px; text-decoration: none; text-align: center; font-weight: bold; transition: all 0.3s;">
                    🤖 Squad Chat
                </a>
        ...
        <section class="container catalog-tools">
            ...
            <div class="admin-link-list">
                ...
                <a class="btn btn-primary" href="/admin/ai-squad.php">Squad Chat</a>
