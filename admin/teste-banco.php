...
try {
    ...
    $host = (string)$db->query('SELECT @@hostname')->fetchColumn();
...
<div class="grid">
<div class="metric"><small>Banco</small><strong><?= $esc($dbName !== '' ? $dbName : '—') ?></strong></div>
<div class="metric"><small>Servidor</small><strong><?= $esc($host !== '' ? $host : '—') ?></strong></div>
