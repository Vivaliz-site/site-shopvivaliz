...
function sva_agent_designer(): array
{
    return array(
        ...
        'suggestions' => array('Criar padrao 1920x620 para banner principal.', 'Criar padrao 1200x420 para capa de categoria.', 'Criar padrao 1080x1080 para chamada social/catalogo.', 'Manter sem texto quando a imagem for usada como foto de produto.'),
    );
}
