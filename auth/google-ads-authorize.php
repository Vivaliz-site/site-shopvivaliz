...
if (!in_array($purpose, ['google_ads', 'gmail_readonly', 'gmail_returns'], true)) {
...
$url = 'https://accounts.google.com/o/oauth2/v2/auth?' . http_build_query([
    ...
    'state' => $state,
    'access_type' => 'offline',
    'include_granted_scopes' => in_array($purpose, ['gmail_readonly', 'gmail_returns'], true) ? 'false' : 'true',
    'prompt' => 'consent',
]);
