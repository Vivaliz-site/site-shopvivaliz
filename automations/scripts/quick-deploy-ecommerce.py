...
<main class="container">
    ...
    <?php if ($produto): ?>
        <div class="card" style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
            <div style="font-size: 8em; text-align: center; background: #f5f7fa; padding: 40px; border-radius: 8px;">
                <?php echo $produto['imagem']; ?>
            </div>
            <div>
                <h1 style="font-size: 2rem; margin-bottom: 1rem;"><?php echo htmlspecialchars($produto['nome']); ?></h1>
                <div style="font-size: 2.5rem; color: var(--primary-color); font-weight: bold; margin-bottom: 1rem;">
                    R$ <?php echo number_format($produto['preco'], 2, ',', '.'); ?>
                </div>
                <div style="color: var(--success-color); font-weight: 600; margin-bottom: 1rem;">
                ...
                <form method="POST" class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantidade" name="quantidade" class="form-control" style="width: 120px;" value="1" min="1" max="<?php echo $produto['estoque']; ?>">
                    </div>
    ...
    <?php else: ?>
        <div class="alert alert-error" style="text-align: center; padding: 3rem;">
            ...
            <a href="/catalogo/index.php" class="btn btn-primary" style="margin-top: 1rem;">Voltar ao Catálogo</a>
        </div>
    <?php endif; ?>
</main>
