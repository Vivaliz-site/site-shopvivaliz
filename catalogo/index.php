...
// Tentar carregar produtos via endpoint ou arquivo
$produtos = [];
$cache_valido = false;

// 1. Tentar arquivo de 198 produtos
$arquivo_produtos = __DIR__ . '/../olist/produtos-198.php';
...
// 2. Se não tiver, tentar endpoint ON-DEMAND
if (empty($produtos)) {
    try {
