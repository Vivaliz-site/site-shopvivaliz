...
export default async function seedShopVivalizTestData({
  ...
  const testProducts = [
    ...
    {
      title: "Camiseta Básica ShopVivaliz",
      handle: "camiseta-basica-shopvivaliz",
      description: "Camiseta 100% algodão, corte reto e caimento confortável.",
      sku: "TSHIRT-001",
    ...
    {
      title: "Vestido Casual ShopVivaliz",
      handle: "vestido-casual-shopvivaliz",
      description: "Vestido leve de tecido fluido, ideal para o dia a dia.",
      sku: "DRESS-001",
    ...
    },
    {
      ...
      description: "Bermuda de sarja com elastano, confortável para o verão.",
      sku: "SHORTS-001",
    ...
    {
      title: "Blusa de Frio ShopVivaliz",
      handle: "blusa-de-frio-shopvivaliz",
      description: "Blusa de moletom com capuz, macia e quentinha.",
      sku: "HOODIE-001",
      image: "https://placehold.co/800x800/2980b9/ffffff/png?text=Blusa",
      weight: 600,
      priceBRL: 159.9,
      priceUSD: 31.9,
    },
    {
      ...
      description: "Bolsa transversal em couro sintético, compacta e resistente.",
      sku: "BAG-001",
    ...
    },
    {
      ...
      handle: "meia-shopvivaliz-kit-3",
      description: "Kit com 3 pares de meias em algodão, cano médio.",
      sku: "SOCKS-001",
      image: "https://placehold.co/800x800/f39c12/ffffff/png?text=Meias",
      weight: 100,
      priceBRL: 39.9,
      priceUSD: 7.9,
    },
