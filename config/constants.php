...
// Email
define('MAIL_HOST', getenv('SMTP_HOST') ?: getenv('SMTP_HOST') ?: getenv('MAIL_HOST') ?: 'smtp.titan.email');
define('MAIL_PORT', getenv('SMTP_PORT') ?: getenv('SMTP_PORT') ?: getenv('MAIL_PORT') ?: 465);
define('MAIL_USER', getenv('SMTP_USER') ?: getenv('SMTP_USER') ?: getenv('MAIL_USER') ?: 'agentes@shopvivaliz.com.br');
define('MAIL_PASS', getenv('SMTP_PASS') ?: getenv('SMTP_PASS') ?: getenv('MAIL_PASS') ?: '');
...
define('FTP_PASSWORD', getenv('FTP_PASSWORD') ?: getenv('FTP_PASSWORD') ?: '');
