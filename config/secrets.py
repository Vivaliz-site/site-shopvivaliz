...
SHOPEE_REDIRECT_URI = os.getenv("SHOPEE_REDIRECT_URI", "https://shopvivaliz.com.br/")
...
TIKTOK_REDIRECT_URL = os.getenv("TIKTOK_REDIRECT_URL", "https://shopvivaliz.com.br")
...
APP_URL = os.getenv("APP_URL", "https://shopvivaliz.com.br")
