...
OLIST_API_KEY = first_env("OLIST_API_KEY", "TOKEN_API_OLIST")
OLIST_SECRET = first_env("OLIST_SECRET")
TINY_CLIENT_ID = first_env("TINY_CLIENT_ID", "CLIENT_ID_API_OLIST")
TINY_CLIENT_SECRET = first_env("TINY_CLIENT_SECRET", "CLIENT_SECRET_OLIST")
TINY_ACCESS_TOKEN = first_env("TINY_ACCESS_TOKEN", "TOKEN_API_OLIST")
TINY_REFRESH_TOKEN = first_env("TINY_REFRESH_TOKEN")
TINY_REDIRECT_URI = first_env("TINY_REDIRECT_URI", "URL_REDIRCT_OLIST")
...
TOKEN_API_OLIST = TINY_ACCESS_TOKEN or OLIST_API_KEY
CLIENT_ID_API_OLIST = TINY_CLIENT_ID
CLIENT_SECRET_OLIST = TINY_CLIENT_SECRET
URL_REDIRCT_OLIST = TINY_REDIRECT_URI
...
PAGARME_SECRET_KEY = first_env("PAGARME_SECRET_KEY")
PAGARME_API_KEY = first_env("PAGARME_API_KEY")
PAGARME_PUBLIC_KEY = first_env("PAGARME_PUBLIC_KEY")
