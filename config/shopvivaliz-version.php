...
return array(
    ...
    'notes' => array(
        ...
        'Ativa o primeiro bloco de Commerce Brain: ranking por performance ligado ao catalogo publico e ao ciclo AutoDev.',
        'Fecha o bloco final de Commerce Brain com receita real, previsao de demanda e recomendacoes acionaveis no AutoDev/admin.',
        'Recupera imagens da vitrine por SKU e Olist ID usando o mapeamento local quando banco ou cache retornarem imagem quebrada.',
        'Materializa endpoints residentes na raiz para relatorio autonomo, watchdog, auditoria de midia e trigger externo.',
        'Reforca self-test e update-applied-check para validar pedidos, watchdog e auditoria residente apos deploy.',
