...
echo "   - APIs aprovadas (Gemini/OpenRouter) nao estao configuradas"
echo "4. POSSÍVEIS PROBLEMAS (APÓS CONFIGURAÇÃO DE SECRETS)..."
echo "   - Variáveis de ambiente GEMINI_API_KEY, OPENROUTER_API_KEY não estão acessíveis ao script."
...
echo "   a) Verificar se GEMINI_API_KEY, OPENROUTER_API_KEY estão configuradas em GitHub Secrets e acessíveis ao workflow."
...
echo "      GEMINI_API_KEY=... OPENROUTER_API_KEY=... python3 scripts/chat-responder-real.py"
