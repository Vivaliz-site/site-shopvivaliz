...
function sv_account_ensure_schema(): void
{
    ...
    $pdo->exec(
        'CREATE TABLE IF NOT EXISTS orders (
            ...
            payment_provider_status VARCHAR(32) NULL,
            payment_provider_id VARCHAR(160) NULL,
            payment_evidence_json TEXT NULL,
            payment_evidence_at DATETIME NULL,
            reconciliation_status VARCHAR(32) NULL,
            reconciliation_json TEXT NULL,
            reconciliation_checked_at DATETIME NULL,
    ...
    $alterations = [
        ...
        'payment_provider_status' => 'ALTER TABLE orders ADD COLUMN payment_provider_status VARCHAR(32) NULL',
        'payment_provider_id' => 'ALTER TABLE orders ADD COLUMN payment_provider_id VARCHAR(160) NULL',
        'payment_evidence_json' => 'ALTER TABLE orders ADD COLUMN payment_evidence_json TEXT NULL',
        'payment_evidence_at' => 'ALTER TABLE orders ADD COLUMN payment_evidence_at DATETIME NULL',
        'reconciliation_status' => 'ALTER TABLE orders ADD COLUMN reconciliation_status VARCHAR(32) NULL',
        'reconciliation_json' => 'ALTER TABLE orders ADD COLUMN reconciliation_json TEXT NULL',
        'reconciliation_checked_at' => 'ALTER TABLE orders ADD COLUMN reconciliation_checked_at DATETIME NULL',
        'attribution_json' => 'ALTER TABLE orders ADD COLUMN attribution_json TEXT NULL',
