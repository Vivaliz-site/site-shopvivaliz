...
final class SvAmazonReturnPolicySeeder
{
    ...
    public static function definitions(): array
    {
        ...
        return [
            ...
            self::row('RETURN_NOT_RECEIVED','A2Q3Y263D00KWC','FBA_ONSITE','2026-04-21',60,'SELLER_DEBIT_AT',$sixtySource,'Amazon BR: pedidos FBA Onsite a partir de 21/04/2026 aguardam 60 dias após reembolso.'),
            self::row('RETURN_NOT_RECEIVED','A2Q3Y263D00KWC','DELIVERY_BY_AMAZON','2026-04-21',60,'SELLER_DEBIT_AT',$sixtySource,'Amazon BR: pedidos Delivery by Amazon a partir de 21/04/2026 aguardam 60 dias após reembolso.'),
        ];
    }
