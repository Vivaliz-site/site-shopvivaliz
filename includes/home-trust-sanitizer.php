 ...
 * demonstrativos. Este filtro roda somente na rota `/`, antes do primeiro byte
 * de HTML, para impedir que crawlers, navegadores sem JS e caches recebam prova
...
HTML;
    ...
    // O fallback externo historico nao deve reaparecer no HTML sem JS. A PR de
    // imagens de categorias substitui por fotos reais; este fallback server-side
    // fica local e neutro em caso de indisponibilidade do catalogo.
