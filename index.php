            ...
            <div class="hero-content">
                ...
                <div class="hero-search-container">
                    <form action="/catalogo" method="GET" class="hero-search-form">
                        ...
                        <input id="hero-search-input" type="search" name="busca" inputmode="search" enterkeyhint="search" autocomplete="off" placeholder="O que você está procurando hoje? Ex: rodízios, ferramentas...">
