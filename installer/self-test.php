...
$checks = [
    ...
    'Integracao ML client presente' => is_file(svself_root() . '/api/ml/client.php'),
    'Git Guardian agent presente' => is_file(svself_root() . '/scripts/git_autonomous_agent.py'),
];
...
echo json_encode([
    ...
    'runtime_endpoints' => [
        ...
        'ml_login' => is_file(svself_root() . '/api/ml/login.php'),
        'ml_callback' => is_file(svself_root() . '/api/ml/callback.php'),
        'ml_token' => is_file(svself_root() . '/api/ml/token.php'),
    ],
