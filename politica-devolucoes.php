...
<div class="legal-box"><strong>Antes de enviar qualquer produto, fale com a equipe.</strong><br>Informe o número do pedido e o motivo da solicitação pelo telefone/WhatsApp <?= htmlspecialchars($phone) ?> ou pelo e-mail <?= htmlspecialchars($email) ?>.</div>
...
<h2>7. Atendimento</h2><p>Telefone/WhatsApp: <strong><?= htmlspecialchars($phone) ?></strong><br>E-mail: <strong><?= htmlspecialchars($email) ?></strong></p>
