...
<h2>4. Autorização e envio</h2><p>Em casos de arrependimento, o custo da postagem de devolução é de responsabilidade do consumidor. Para defeito, avaria, divergência ou outra hipótese em que a legislação determine tratamento diferente, a equipe orientará o procedimento aplicável e, quando devido, fornecerá a forma de devolução. Não envie produtos sem autorização e instruções de postagem ou coleta.</p>
