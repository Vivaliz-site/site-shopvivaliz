...
<h2>4. Autorização e envio</h2><p>Para solicitar devolução, entre em contato antes do envio para receber as instruções corretas de postagem ou coleta. No direito de arrependimento e nas hipóteses de defeito, avaria ou divergência, a ShopVivaliz orientará o procedimento conforme a legislação aplicável e a análise do caso. Não envie produtos sem autorização e instruções de atendimento.</p>
