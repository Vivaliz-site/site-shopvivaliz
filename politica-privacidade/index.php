    ...
    <section class="brand-hero">
        <div class="container">
            <div class="brand-hero-card">
                <span class="brand-eyebrow">Privacidade</span>
                <h1>Tratamento de dados com linguagem mais clara e leitura melhor em qualquer tela.</h1>
                <p>A política foi reorganizada visualmente para ficar consistente com o restante da experiência pública da Vivaliz.</p>
            </div>
        </div>
    </section>
    <div class="container">
