...
<h2>9. Como exercer seus direitos</h2><p>Envie a solicitação para <strong><?= htmlspecialchars($email) ?></strong>. Para proteger o titular, poderemos pedir informações razoáveis de verificação de identidade.</p>
