...
SECRETS_MAP = {
    ...
    'FTP_SERVER': ['FTP_SERVER', 'FTP_ADDRESS', 'FTPHOST', 'FTP_SERVER_ADDRESS'],
    'FTP_USERNAME': ['FTP_USERNAME', 'FTP_ACCOUNT', 'FTP_LOGIN'],
    'FTP_PASSWORD': ['FTP_PASSWORD', 'FTP_PWD', 'FTP_SECRET'],
    ...
    'SMTP_USER': ['SMTP_USER', 'EMAIL_ACCOUNT', 'EMAIL_LOGIN'],
    'SMTP_PASS': ['EMAIL_PASS', 'SMTP_PASSWORD', 'EMAIL_SECRET'],
