...
def main() -> int:
    ...
    checks = {
        ...
        "rewrite_rule_present": "RewriteRule ^produto/([a-z0-9][a-z0-9\\-]*[0-9]+)/?$ produto.php?slug=$1 [L,QSA]" in htaccess,
    ...
    report = {
        "summary": checks,
        "status": "ok" if checks["products_with_slug"] == checks["unique_slugs"] == checks["catalog_products"] else "warning",
    }
