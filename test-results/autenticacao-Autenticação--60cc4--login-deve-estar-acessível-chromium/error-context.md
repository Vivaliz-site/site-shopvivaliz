...
- Name: autenticacao.spec.ts >> Autenticação >> página de login deve estar acessível
- Location: tests\autenticacao.spec.ts:6:7
...
Expected pattern: /Login.*ShopVivaliz/i
Received string:  ""
Timeout: 5000ms
