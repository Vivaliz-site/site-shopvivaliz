...
// Regressao do incidente real: cadastro legado sem marca/modelo pode ter nome
// iniciado por copy promocional. O sistema nao pode exigir esse prefixo como
// identidade e, ao mesmo tempo, reprova-lo como hype.
$legacyProduct = [
    'name' => 'Imperdivel: Garanta ja Suporte Universal para Celular!?',
    'description' => 'Suporte universal para celular com fixacao ajustavel.',
    'category' => 'Acessorio',
    'brand' => '',
    'model' => '',
    'sku' => 'LEGACY-1',
    ...
    'size' => '',
    'material' => '',
    'specs' => 'Fixacao ajustavel',
    'olist_id' => '',
];
$legacyRaw = [
    'optimized_title' => 'Imperdivel! Garanta ja Suporte Universal para Celular?',
    'optimized_description' => 'Suporte universal para celular com fixacao ajustavel.',
    'bullet_points' => ['Suporte universal', 'Fixacao ajustavel', 'Uso para celular'],
    'seo_keywords' => ['suporte celular'],
    'marketing_hooks' => [],
    'meta_title' => 'Suporte Universal para Celular',
    'meta_description' => 'Suporte universal para celular com fixacao ajustavel.',
];
...
catalog_normalizer_assert((string)$legacyProduct['name'] === 'Suporte Universal para Celular', 'identidade legado deve descartar copy promocional da origem');
catalog_normalizer_assert(ai_catalog_title_starts_with_identity((string)$legacyNormalized['optimized_title'], $legacyProduct), 'titulo legado deve iniciar pela identidade factual limpa');
catalog_normalizer_assert(!ai_catalog_title_has_hype_prefix((string)$legacyNormalized['optimized_title']), 'titulo legado normalizado nao pode manter hype');
catalog_normalizer_assert($legacyHard === [], 'cadastro legado deve sair sem hard failure deterministica: ' . implode(', ', $legacyHard));

// O pool Gemini deve incluir todos os aliases privados previstos e deduplicar
// valores repetidos. O teste usa sentinelas locais; nenhum segredo real e lido.
...
fwrite(STDOUT, "COMPROVADO: providers auto-normalizam identidade/claims/limites; legado com hype e pool Gemini multiplo protegidos.\n");
