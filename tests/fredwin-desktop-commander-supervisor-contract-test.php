...
foreach (['@wonderwhy-er/desktop-commander@0.2.48','remote','--persist-session','Please complete authentication','Starting device authorization flow','device code','AUTH_REQUIRED','RedirectStandardOutput = $true','RedirectStandardError = $true'] as $needle) {
